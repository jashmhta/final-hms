...
Performs comprehensive security checks on the HMS system
"""
...
class SecurityAuditor:
    """Comprehensive security auditor for HMS"""
    ...
    def check_dependencies(self):
        ...
        try:
            ...
            self.results['checks']['dependencies'] = {
                ...
                'details': vulnerabilities[:10]  # Limit output
            }
    ...
    def check_ssl_tls(self):
        ...
        # Check settings for SSL configuration
    ...
    def check_firewall_rules(self):
        ...
        # This would need to be implemented based on deployment environment
    ...
    def check_database_security(self):
        ...
        if settings_file.exists():
            ...
            # Check for plain text passwords (should use environment variables)
    ...
    def check_audit_logging(self):
        ...
        # Check for security events model
        if (self.base_path / 'backend' / 'authentication' / 'models.py').exists():
            with open(self.base_path / 'backend' / 'authentication' / 'models.py', 'r') as f:
                content = f.read()
    ...
    def generate_report(self):
        ...
        print("
📈 Audit Summary:"        print(f"   Total Checks: {summary['total_checks']}")
