        ...
        return {
            "architecture_layers": {
                "presentation_layer": {
                    ...
                    "responsibilities": ["user_interface", "request_routing", "authentication"]
                },
                "application_layer": {
                    "components": ["microservices", "business_logic", "api_endpoints"],
                    "technologies": ["django", "fastapi", "graphql"],
                    "responsibilities": ["business_logic", "data_processing", "service orchestration"]
                },
                "data_layer": {
                    "components": ["databases", "cache", "message_queue"],
                    "technologies": ["postgresql", "redis", "rabbitmq"],
                    "responsibilities": ["data_storage", "caching", "message_processing"]
                },
                "infrastructure_layer": {
                    "components": ["kubernetes", "docker", "load_balancers"],
                    "technologies": ["k8s", "docker", "nginx"],
                    "responsibilities": ["containerization", "orchestration", "networking"]
                }
            },
...
def main():
    ...
    print("=" * 50)
    print(f"Response Time: {performance['performance_targets_achieved']['response_time']}")
    print(f"Throughput: {performance['performance_targets_achieved']['throughput']}")
    print(f"Availability: {performance['performance_targets_achieved']['availability']}")
    print(f"Database Performance: {performance['database_performance']['query_optimization']}")
    print()
    ...
    phase_output_path = "/home/azureuser/hms-enterprise-grade/phase_by_phase_summary.json"
