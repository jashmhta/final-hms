...
class ServiceRegistry:
    ...
    async def register_service(self, service_name: str, address: str, port: int,
...
class ServiceMesh:
    ...
    async def call_service(self, service_name: str, method_name: str,
                          request_data: Any, timeout: int = 30) -> Any:
    ...
    async def _make_service_call(self, instance: Dict, method_name: str,
