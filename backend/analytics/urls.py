...
from .views import OverviewStatsView, PredictionViewSet, AnomalyViewSet, EquipmentPredictionViewSet, ReadmissionPredictionView
...
urlpatterns = [
    ...
    path("analytics/readmission/", ReadmissionPredictionView.as_view(), name="readmission-prediction"),
