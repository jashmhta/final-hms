...
urlpatterns = [
    ...
    # Data retention
    path(
        "api/data-retention/", views.DataRetentionView.as_view(), name="data-retention"
    ),
    # Compliance reports
    path(
        "api/reports/", views.ComplianceReportView.as_view(), name="compliance-reports"
    ),
    ...
    path(
        ...
        include(
            [
                path(
                    "hipaa/", views.HIPAADocumentationView.as_view(), name="hipaa-docs"
                ),
