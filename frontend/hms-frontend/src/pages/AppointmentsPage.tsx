...
export default function AppointmentsPage() {
  ...
  const checkSlots = async () => {
    const r = await axios.get("/api/appointments/available_slots/", {
  ...
  const createAppointment = async () => {
    ...
    const endAt = new Date(
      startAt.getTime() + parseInt(durationMin, 10) * 60000,
    );
    ...
    <Container sx={{ my: 3 }}>
      ...
      <Paper sx={{ p: 2, mb: 2 }}>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
          ...
          <Button
            ...
            disabled={!patientId || !doctorId || !start || !hospitalId}
          >
            Create
          </Button>
        </Stack>
      ...
      <Paper sx={{ p: 2 }}>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
          ...
          />
          <Button variant="contained" onClick={checkSlots}>
            Check
          </Button>
        </Stack>
