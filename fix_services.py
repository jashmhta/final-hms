...
def create_missing_files():
    ...
    services_to_fix = [
        "prescription", "operation_theatre", "graphql_gateway", "ot_scheduling",
        "ambulance", "triage", "lab", "facilities", "mrd", "consent", "pharmacy",
        "compliance_checklists", "billing", "price_estimator", "appointments",
        "feedback", "audit", "notifications", "erp", "hr", "analytics_service",
        "radiology", "er_alerts", "patients"
    ]
