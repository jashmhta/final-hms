...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/home/azureuser/helli/enterprise-grade-hms/testing/backend_testing.log'),
    ...
    async def test_api_endpoints(self):
        ...
        api_endpoints = {
            ...
            'patients': [
                ...
                {'method': 'GET', 'path': '/api/patients/1/', 'description': 'Get patient details'},
                {'method': 'PUT', 'path': '/api/patients/1/', 'description': 'Update patient'},
                {'method': 'DELETE', 'path': '/api/patients/1/', 'description': 'Delete patient'}
            ],
            'appointments': [
                ...
                {'method': 'GET', 'path': '/api/appointments/1/', 'description': 'Get appointment details'},
                {'method': 'PUT', 'path': '/api/appointments/1/', 'description': 'Update appointment'},
                {'method': 'DELETE', 'path': '/api/appointments/1/', 'description': 'Delete appointment'}
            ],
            'medical_records': [
                {'method': 'GET', 'path': '/api/medical-records/', 'description': 'List medical records'},
                {'method': 'POST', 'path': '/api/medical-records/', 'description': 'Create medical record'},
                {'method': 'GET', 'path': '/api/medical-records/1/', 'description': 'Get medical record details'},
                {'method': 'PUT', 'path': '/api/medical-records/1/', 'description': 'Update medical record'}
            ],
            'billing': [
                {'method': 'GET', 'path': '/api/billing/', 'description': 'List billing records'},
                {'method': 'POST', 'path': '/api/billing/', 'description': 'Create billing record'},
                {'method': 'GET', 'path': '/api/billing/1/', 'description': 'Get billing details'},
                {'method': 'PUT', 'path': '/api/billing/1/', 'description': 'Update billing record'}
            ],
            'auth': [
